...
export function QismLaporan({ config }: Props) {
  ...
  const handleExportPDF = () => {
    ...
    try {
      ...
      doc.text(config.laporanTitle, 105, 18, { align: 'center' });
      doc.setFontSize(11);
      doc.setFont('helvetica', 'normal');
      doc.text(`${config.title} OSBA`, 105, 25, { align: 'center' });
      doc.setFontSize(9);
      ...
      doc.text(config.pengawasLabel, 150, finalY + 6);
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between print:hidden">
        <div>
          ...
          <p className="text-sm text-gray-400">{config.laporanSubtitle}</p>
        </div>
      ...
      <div id="print-content" className="bg-white border border-gray-200 rounded-xl shadow-sm p-6 print:shadow-none print:border-none print:rounded-none">
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold">{config.laporanTitle}</h2>
          <p className="text-sm text-gray-600">{config.title} OSBA</p>
        ...
        <div className="mt-8 flex items-end justify-between text-xs text-gray-400">
          ...
          <div className="text-right">
            ...
            <p className="text-blue-600 font-medium">{config.pengawasLabel}</p>
